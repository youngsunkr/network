...
import net.wikidocs.tels.ByteUtil;
...
public class TcpUtil
{
    ...
    */
    ...
    public static final void setshort(OutputStream out, short s) throws Exception{
        byte[] buf = new byte[2];
        out.write(net.wikidocs.tels.ByteUtil.setshort(buf, 0, s));
    }
    ...
    public static final void setint(OutputStream out, int i) throws Exception{
        byte[] buf = new byte[4];
        out.write(net.wikidocs.tels.ByteUtil.setint(buf, 0, i));
    }
    public static final void setlong(OutputStream out, long l) throws Exception{
        byte[] buf = new byte[8];
        out.write(net.wikidocs.tels.ByteUtil.setlong(buf, 0, l));
    }
    public static final void setfloat(OutputStream out, float f) throws Exception{
        byte[] buf = new byte[4];
        out.write(net.wikidocs.tels.ByteUtil.setfloat(buf, 0, f));
    }
